...
- Name: chat-flow-complete.spec.ts >> Complete Chat Flow E2E >> should display error if workflow trigger fails
- Location: tests/e2e/chat-flow-complete.spec.ts:94:7
...
- generic [ref=e5]:
  ...
  - generic [ref=e8] [cursor=pointer]:
    - checkbox "Trigger Agent Workflow" [ref=e9]
