"""Specialist agents for skills lead, repo scouting, and solution planning."""
from abc import ABC
...
class RepoScoutAgent(BaseSpecialistAgent):
    ...
    def __init__(self, repository_path: str, model_name: str = "gpt-4", mock_mode: bool = False, llm_provider: Optional[str] = None):
        super().__init__(model_name=model_name, mock_mode=mock_mode, llm_provider=llm_provider)
