...
@pytest.mark.e2e
async def test_chat_lifecycle_with_nats():
...
@pytest.mark.e2e
async def test_chat_start_without_repository():
...
@pytest.mark.e2e
async def test_nats_subject_patterns():
...
@pytest.mark.e2e
async def test_control_plane_nats_integration():
